...
SPECTACULAR_SETTINGS = {
    "TITLE": "Svity Pokrov",
    "DESCRIPTION": (
        "API documentation for the project, providing clear "
        "and structured information about available endpoints, "
        "request/response formats, and authentication methods. "
        "Designed to help developers easily understand and integrate "
        "with the system."
    ),
    "VERSION": "1.0.0",
